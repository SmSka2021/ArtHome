...
<form action="#" method="post">
      ...
      <input type="tel" name="tel" class="tel_form" id="tel_modal" placeholder="Phone +375331231212" required>
      <p class="error error_tel_modal">Incorrect phone</p>
      <div class="container_checkbox">
          <label class="label_checkbox">
              <input type="checkbox" name="checkbox" id="checkbox_modal" 
                  required>
              <span>I accept Privacy policy</span> <a href="./pages/privacy_policy.html">Our Policy</a>
          </label>
      </div>
      <button type="button" onclick="window.location.href='./pages/thanks.html'" id="btnForm_modal" class="btn btn_small btn_center">Order call</button>
  </form>
  </div>  
`;
